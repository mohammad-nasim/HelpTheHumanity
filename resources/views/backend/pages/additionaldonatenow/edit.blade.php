...
@section('title')
Update Data - Additional Donate Now Section
@endsection
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-white">
                    ...
                    <!-- form start -->
                    <form action="{{ route('additionaldonatenow.update', $show->id) }}" method="post" enctype="multipart/form-data" id="form-id">
                        @csrf
                        @method('put')
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            <div class="mb-4">
                                ...
                                <img src="{{asset('backend/img/app_image/add_donate_now/'.$show->bg_image)}}" style="width:360px;height:180px" alt="">
                            </div>
                            <div class="form-group">
                          ...
                          <div class="form-group">
                            <div class="mb-4">
                                <label for="">Previous Cover Image</label><br>
                                <img src="{{asset('backend/img/app_image/add_donate_now/'.$show->cover_image)}}" style="width:360px;height:180px" alt="">
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Update Image </label>
