                ...
                <div class="card">
                    <div class="card-header ">
                        <div class="d-flex justify-content-between ">
                            ...
                            <a target="_self"  href="{{ route('feature.create') }}" class="btn btn-primary">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex" style="width: 120px">
                                        ...
                                        <a href="{{ route('feature.edit',$data->id) }}" class="btn btn-sm btn-success fa fa-edit text-white mr-1"></a>
