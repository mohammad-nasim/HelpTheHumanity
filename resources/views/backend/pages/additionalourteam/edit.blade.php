...
@section('title')
Update Data - Additional Our Team
@endsection
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-white">
                    ...
                    <!-- form start -->
                    <form action="{{ route('additionalourteam.update', $show->id) }}" method="post" enctype="multipart/form-data" id="form-id">
                        @csrf
                        @method('put')
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            <div class="mb-4">
                                ...
                                <img src="{{asset('backend/img/app_image/add_our_team/'.$show->cover_image)}}" style="width:360px;height:180px" alt="">
                            </div>
                            <div class="form-group">
