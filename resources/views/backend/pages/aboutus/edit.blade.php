    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-12 d-flex justify-content-between">
                <h1 class="m-0 lead">Update About Us Seciton</h1>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-white">
                    ...
                    <!-- form start -->
                    <form action="{{ route('aboutus.update', $show->id) }}" method="post" enctype="multipart/form-data" id="form-id">
                        @csrf
                        @method('put')
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            <div class="mb-4">
                                ...
                                <img src="{{asset('backend/img/app_image/about_us/'.$show->image)}}" style="width:290px;height:140px" alt="">
                            </div>
                            <div class="form-group">
