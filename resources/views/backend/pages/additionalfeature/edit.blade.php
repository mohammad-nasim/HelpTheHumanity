    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-12 d-flex justify-content-between">
                <h1 class="m-0 lead">Update Additional Feature Data</h1>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-white">
                    ...
                    <!-- form start -->
                    <form action="{{ route('additionalfeature.update', $show->id) }}" method="post" enctype="multipart/form-data" id="form-id">
                        @csrf
                        @method('put')
                        <div class="card-body">
